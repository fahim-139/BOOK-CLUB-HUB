    ...
    <section class="featured-genres">
        <div class="container">
            ...
            <div class="genre-grid">
                <a href="fiction.html" class="genre-card fiction">
                    <h4>Fiction</h4>
                    <p>Explore imaginary worlds and compelling characters</p>
                </a>
                <a href="sci-fi.html" class="genre-card scifi">
                    <h4>Sci-Fi</h4>
                    <p>Journey through futuristic landscapes</p>
                </a>
                <a href="romance.html" class="genre-card romance">
                    <h4>Romance</h4>
                    <p>Fall in love with timeless stories</p>
                </a>
                <a href="fantasy.html" class="genre-card fantasy">
                    <h4>Fantasy</h4>
